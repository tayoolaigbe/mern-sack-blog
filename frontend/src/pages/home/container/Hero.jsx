		...
		<section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
			<div className="mt-10 lg:w-1/2">
				...
				<p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
					...
					reiciendis fugiat fuga autem facilis ipsam eaque non officiis sunt
					atque. Sunt sed maxime consectetur nostrum sequi, quis similique at
					odio.
				</p>
				<div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
					...
					<button className="e-full bg-primary text-white font-semibold rounded-lg px-5 py-3 md:absolute md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2">
						Search
					</button>
				</div>
				<div className="flex mt-4 flex-col lg:flex-row lg:items-start lg:flex-nowrap lg:gap-x-4 lg:mt-7">
					...
					<ul className="flex flex-wrap gap-x-2.5 gap-y-2.5 mt-3 lg:text-sma xl:text-base">
