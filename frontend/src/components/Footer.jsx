...
const Footer = () => {
	return (
		<section className="bg-dark-hard">
			<footer className="container mx-auto grid grid-cols-10 px5 py-10 gap-y-10 gap-x-5 md:pt-20 md:grid-cols-12 lg:grid-cols-10 gap-x-10">
				...
				<div className="col-span-10 md:order-first md:col-span-4 lg:col-span-2">
					...
					<p className="text-sm text-dark-light text-center mt-4 md:text-left md:text-base lg:text-sm">
						Build a modern and creative website with gidisquare.
					</p>
